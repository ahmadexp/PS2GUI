...
*(v0.6 removed the old launcher + PS2TUI text menu; v0.7 was a transitional list-with-icons; v0.8 made
it a true icon grid; v0.9 gives every item its own creative icon.)*
